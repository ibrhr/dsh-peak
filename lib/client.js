		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("span", { children: isOffPeak ? "🌙" : "⚡" }), /* @__PURE__ */ jsx("span", { children: t.statusTitle })]
				}), /* @__PURE__ */ jsx("button", {
					type: "button",
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("span", { children: "📅" }), /* @__PURE__ */ jsx("span", { children: t.officialSchedule })]
					}),
					/* @__PURE__ */ jsxs("div", {
						className: PeakBadge_module_default.scheduleRow,
						children: [/* @__PURE__ */ jsxs("span", { children: ["• ", t.morningPeak] }), /* @__PURE__ */ jsx("span", {
							style: {
								color: "#ef4444",
								fontWeight: 600
							},
					...
					/* @__PURE__ */ jsxs("div", {
						className: PeakBadge_module_default.scheduleRow,
						children: [/* @__PURE__ */ jsxs("span", { children: ["• ", t.afternoonPeak] }), /* @__PURE__ */ jsx("span", {
							style: {
								color: "#ef4444",
								fontWeight: 600
							},
					...
					/* @__PURE__ */ jsxs("div", {
						className: PeakBadge_module_default.scheduleRow,
						children: [/* @__PURE__ */ jsxs("span", { children: ["• ", t.offPeakAllOther] }), /* @__PURE__ */ jsx("span", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					children: [/* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { children: [
						/* @__PURE__ */ jsx("th", { children: t.model }),
						/* @__PURE__ */ jsx("th", { children: t.cacheHit }),
						/* @__PURE__ */ jsx("th", { children: t.cacheMiss }),
						/* @__PURE__ */ jsx("th", { children: t.output })
					] }) }), /* @__PURE__ */ jsx("tbody", { children: Object.values(DEEPSEEK_MODELS).map((m) => /* @__PURE__ */ jsxs("tr", { children: [
						/* @__PURE__ */ jsx("td", {
							style: { fontWeight: 500 },
							children: m.name
						}),
						/* @__PURE__ */ jsxs("td", { children: [/* @__PURE__ */ jsxs("span", {
							style: {
								textDecoration: isOffPeak ? "line-through" : "none",
								opacity: isOffPeak ? .6 : 1
							},
							children: ["$", m.peak.inputCacheHit]
						}), isOffPeak && /* @__PURE__ */ jsxs("span", {
							className: PeakBadge_module_default.discountCol,
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("strong", { children: ["💡 ", t.tipHeading] }), t.tipText]
			})
		]
	});
};
...
const PeakBadge = ({ initialDate, config, locale = "en", compact = false, className = "", style }) => {
	const [status, setStatus] = useState(() => getPeakStatus(initialDate || /* @__PURE__ */ new Date(), config, locale));
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("button", {
			...
			children: [
				/* @__PURE__ */ jsx("span", { className: PeakBadge_module_default.dot }),
				/* @__PURE__ */ jsx("span", { children: isOffPeak ? t.offPeak : t.peak }),
				isOffPeak && !compact && /* @__PURE__ */ jsx("span", {
		...
		}), isPopoverOpen && /* @__PURE__ */ jsx(PeakPopover, {
			status,
			locale,
...
//#endregion
export { PeakBadge, PeakPopover, apply, inject, mountPeakBadge };
